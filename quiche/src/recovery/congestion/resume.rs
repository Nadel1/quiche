// IMPORTANT: COPIED FROM https://github.com/ana-cc/quiche/blob/resume_latest/quiche/src/recovery/congestion/resume.rs (11.08.2025)
// NOT MY CODE! 
...
impl Resume {
    ...
    #[cfg(feature = "qlog")]
    pub fn maybe_qlog(
        &mut self, cwnd: usize, ssthresh: usize,
    ) -> Option<EventData> {
...
mod tests {
    ...
    use crate::{packet, ranges, CongestionControlAlgorithm};
    ...
    fn no_rtt_sample() {
        ...
        for i in 0..10 {
            ...
            assert_eq!(
                r.epochs[packet::Epoch::Application].sent_packets.len(),
                i + 1
            );
    ...
    fn mj_cr_test() {
        ...
        for i in 0..9 {
            ...
            assert_eq!(
                r.congestion.sent[packet::Epoch::Application].len(),
                i + 1
            );
